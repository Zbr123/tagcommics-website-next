      ...
      <nav className="sticky top-0 z-50 bg-black shadow-2xl">
        <div className="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:flex items-center gap-6 py-2 border-t border-white/10">
            ...
            <Link href="/admin" className={`flex items-center gap-1.5 text-sm font-semibold transition-colors ${pathname === "/admin" || pathname?.startsWith("/admin") ? "text-yellow-400" : "text-white hover:text-yellow-400"}`}>
