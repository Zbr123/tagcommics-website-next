...
function FooterLogoMark() {
  return (
    <span
      className="inline-flex h-[52px] w-[52px] flex-shrink-0 items-center justify-center rounded-xl border border-[rgba(88,232,193,0.28)] bg-black/40 transition-transform group-hover:scale-105"
      aria-hidden
    >
      <svg viewBox="0 0 448 512" className="h-5 w-5" fill="rgb(88, 232, 193)">
        <path d={BOLT_PATH} />
      </svg>
    </span>
  );
        ...
        <div className="mt-10 flex flex-col items-center gap-6 border-t border-white/5 pt-10 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="group flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg bg-gray-900 transition-all hover:bg-brand/80"
              aria-label="Facebook"
            >
              <svg
                className="h-5 w-5 text-gray-400 transition-colors group-hover:text-black"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
