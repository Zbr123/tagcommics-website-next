...
const allComics = [
  ...
  { id: 7, title: "X-Men #1", author: "Stan Lee", price: 5.99, originalPrice: 11.99, discount: 51, rating: 4.9, sold: "2.1k", image: "/comic_slider7.png.jpg", category: "Comics", tag: "BESTSELLER", description: "The original X-Men team assembles! Follow Professor X's students as they learn to control their mutant powers.", stock: 60, inCart: 987 },
  { id: 8, title: "Superman Returns", author: "Jerry Siegel", price: 7.49, originalPrice: 14.99, discount: 50, rating: 4.7, sold: "1.5k", image: "/comic_slider8.png.jpg", category: "Comics", tag: "CLASSIC", description: "The Man of Steel's epic return to Metropolis. A modern take on the classic superhero story.", stock: 35, inCart: 712 },
  { id: 9, title: "Marvel Masterworks", author: "Stan Lee", price: 19.99, rating: 4.9, sold: "2.5k", image: "/comic_slider9.png.jpg", category: "Graphic Novels", tag: "BESTSELLER", description: "A collection of classic Marvel stories in a premium hardcover edition. Perfect for collectors and fans.", stock: 20, inCart: 543 },
  { id: 10, title: "DC Black Label", author: "Various", price: 16.99, rating: 4.7, sold: "1.8k", image: "/comic_slider10.png.jpg", category: "Graphic Novels", tag: "NEW", description: "Mature-themed DC stories in this premium collection. Features some of the best writers and artists in comics.", stock: 15, inCart: 389 },
